  ...
  async function sendHandler() {
    ...
    if (valueRequest.fullName && valueRequest.phone && valueRequest.description) {
      try {
        ...
        toast.success("Произашло ошибка!")
      }
    }
  }
                ...
                {ourSewing.map((e, index) => (
                  <Box data-aos="fade-up" data-aos-anchor-placement="center-bottom"
                    ...
                    {/* <Box sx={{
                      ...
                      component="img" src={e.image} alt="image1" /> */}
                    <Box sx={{ width: "100%" }}>
                      <Image style={{ border: "1px #e2e2e2 solid", borderRadius: "20px" }} src={e.image} width={0} height={0} layout="responsive" />
                    </Box>
                    <Box sx={{ borderRadius: "0 0 20px 20px", position: "absolute", bottom: 4, background: "#0000003e", padding: { md: "0 10px", xs: "0 4px" } }}>
                      ...
                      <Typography sx={{ width: "100%", fontSize: { md: "14px", xs: "12px" }, textAlign: "center", fontWeight: 300, color: "white" }}>{e.des}</Typography>
                    </Box>
                  </Box>
                ))}
              </Box>
